...
void generatejson_systematics()
{
    ...
    for (int i = 0; i < njson; i++)
    {
        ...
        nsigmatpcKa = nsigmatpcKlim[0] + i * (nsigmatpcKlim[1] - nsigmatpcKlim[0]) / (njson - 1) ;
        nsigmatpcPi = nsigmatpcPilim[0] + i * (nsigmatpcPilim[1] - nsigmatpcPilim[0]) / (njson - 1) ;
        nsigmatpcPr = nsigmatpcPrlim[0] + i * (nsigmatpcPrlim[1] - nsigmatpcPrlim[0]) / (njson - 1) ;
